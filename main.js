...
function injectStyles() {
  ...
  style.textContent = `
    ...
    * { box-sizing: border-box; }
    ...
    .brand-wrap { display: flex; align-items: center; gap: .8rem; min-width: 0; }
    .brand-logo { width: clamp(52px, 5vw, 72px); height: clamp(52px, 5vw, 72px); border-radius: 12px; object-fit: contain; padding: .35rem; background: rgba(255,255,255,0.88); border: 1px solid rgba(255,255,255,0.45); box-shadow: 0 8px 24px rgba(0,0,0,.28); flex: 0 0 auto; }
