...
function injectStyles() {
  ...
  style.textContent = `
    ...
    * { box-sizing: border-box; }
    ...
    .topbar { position: sticky; top: 0.4rem; z-index: 10; backdrop-filter: blur(16px); background: rgba(9, 14, 23, 0.78); border: 1px solid var(--line); border-radius: 14px; padding: 0.3rem 0.8rem; box-shadow: 0 16px 36px rgba(0,0,0,0.32); display: flex; align-items: center; justify-content: space-between; gap: 0.75rem; }
    ...
    .tab { border: 1px solid transparent; color: var(--muted); padding: 0.44rem 0.76rem; border-radius: 999px; font-size: 0.9rem; transition: 180ms ease; background: transparent; cursor: pointer; font-weight: 600; white-space: nowrap; }
