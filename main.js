(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      :root{--bg:#FFF9D9;--card:#FFFFFF;--text:#24382F;--muted:#66766E;--olive:#72A982;--deep-olive:#2F6F55;--gold:#F7CA4D;--brown:#C56E8B;--border:#F1E6B8;--success:#3F8B63;--warning:#D99A25;--error:#B85050;--shadow:0 18px 45px rgba(82,105,69,.10);--soft:0 8px 22px rgba(82,105,69,.08)}
      *{box-sizing:border-box} html{scroll-behavior:smooth} body{margin:0;background:radial-gradient(circle at 10% 0%,rgba(255,235,244,.95) 0,transparent 28%),radial-gradient(circle at 90% 8%,rgba(218,247,226,.95) 0,transparent 30%),linear-gradient(135deg,#fffdf1 0,#fff7cb 45%,#f3ffe9 100%);color:var(--text);font-family:Inter,system-ui,-apple-system,Segoe UI,sans-serif;-webkit-font-smoothing:antialiased} button,input,select,textarea{font:inherit} button{min-height:44px} a{color:inherit}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
      ...
      @media(max-width:660px){.availability-strip{grid-template-columns:1fr}.showcase-shell{padding:8px;border-radius:24px}.showcase-image-wrap{min-height:390px;border-radius:20px}.showcase-overlay{background:linear-gradient(0deg,rgba(47,111,85,.78),rgba(47,111,85,.12))}.showcase-badge{top:14px;left:14px}.showcase-copy{left:18px;right:18px;bottom:52px}.showcase-title{font-size:2rem}.showcase-subtitle{font-size:.98rem}.showcase-controls{display:none}.stepper{grid-template-columns:1fr 1fr}.step-pill{text-align:left}.mobile-cart-bar.empty{display:none}.site{padding-left:8px;padding-right:8px}.topbar{border-radius:18px}.brand-mark{width:48px;height:48px;border-radius:16px;font-size:1.05rem}.hero{padding:20px;border-radius:24px}.hero-visual,.hero-visual img{min-height:270px}.grid-2,.grid-3,.grid-4,.footer-grid,.form-grid,.quote-list{grid-template-columns:1fr}.section-head{align-items:start;flex-direction:column}.menu-card{grid-template-columns:1fr}.menu-card img{height:210px}.portion-grid{grid-template-columns:1fr}.date-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.checkout-grid{gap:12px}.panel,.step{padding:16px}.brand-name{font-size:1rem}.brand-tagline{font-size:.76rem}}
    `;
