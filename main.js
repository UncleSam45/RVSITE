(() => {
  ...
  function injectPremiumStyles() {
    ...
    style.textContent = `
      ...
      .availability-strip{box-shadow:0 16px 40px rgba(47,111,85,.1);border-color:rgba(255,255,255,.7)!important;background:rgba(255,253,247,.8)!important;backdrop-filter:blur(18px)}
      ...
      .reveal-ready{opacity:0;transform:translateY(38px) scale(.985);filter:blur(5px)}.reveal-ready.is-visible{opacity:1;transform:none;filter:none;transition:opacity .9s var(--premium-ease),transform .9s var(--premium-ease),filter .9s ease}.grid>.reveal-ready:nth-child(2){transition-delay:.09s}.grid>.reveal-ready:nth-child(3){transition-delay:.18s}.grid>.reveal-ready:nth-child(4){transition-delay:.27s}
      ...
      @media(prefers-reduced-motion:reduce){*,*::before,*::after{scroll-behavior:auto!important;animation-duration:.01ms!important;animation-iteration-count:1!important;transition-duration:.01ms!important}.reveal-ready{opacity:1;transform:none;filter:none}.showcase-slide.active .showcase-image{transform:none}}
    `;
    document.head.appendChild(style);
  }
