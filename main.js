(() => {
  ...
  const state = {
    ...
    admin: { authenticated: false, token: '', owner: 'UncleSam45', repo: 'RVSITE', branch: 'main', working: null, original: null, selectedFile: 'assets/data/content.json', message: '', saving: false, editorValid: true },
  };
