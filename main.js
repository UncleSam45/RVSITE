  ...
  function menuPageHtml() {
    ...
    return `
      <div class="container menu-layout">
        <div>
          <section class="menu-banner" aria-label="Real Food. Real Convenience."><img src="banner.png" alt="Real Food. Real Convenience. Homemade meals, ready when you are." loading="eager" onerror="this.closest('.menu-banner').style.display='none'"></section>
